...
export default function LandingInstallButtons({
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <span>
            <Typography
              component="span"
              sx={{ display: "block", fontSize: 10, fontWeight: 400, opacity: 0.62 }}
            >
      ...
      >
        <DialogTitle sx={{ fontFamily: redesignedFonts.displayFallback, fontWeight: 300, fontSize: 30, pb: 1 }}>
          {activeGuide === "ios"
        ...
        <DialogContent sx={{ pt: "8px !important", pb: 3 }}>
          <Stack spacing={1.5}>
            <Typography sx={{ color: redesignedPalette.text.secondary, lineHeight: 1.7 }}>
              {activeGuide === "ios"
                ? getTranslation("landing.install.ios.description")
                : canPromptInstall
                  ? getTranslation("landing.install.android.descriptionPrompt")
                  : getTranslation("landing.install.android.descriptionFallback")}
            </Typography>
            <Stack spacing={1}>
              {(activeGuide === "ios"
                ? [
                ...
                >
                  ...
                  <Typography sx={{ color: redesignedPalette.text.secondary, lineHeight: 1.6 }}>
                    {step}
                  </Typography>
                </Box>
              ))}
